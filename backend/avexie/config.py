...
RAG_RERANKING_MODEL_AUTO_UPDATE = (
    not OFFLINE_MODE and os.getenv('RAG_RERANKING_MODEL_AUTO_UPDATE', 'False').lower() == 'true'
)
...
# OAuth/OIDC SSO login providers (Google, Microsoft, GitHub, generic OIDC,
# Feishu) have been removed. Only local username/password authentication
# is supported.
